---
layout: default
title: Synology Appdata backup
date: 2026-03-17 18:00:00 +0800
---

# Purpose
- Mimic Unraid appdata backup in Synology

# Steps
- `mkdir -p /volume1/docker/appdata-backup`
- `nano /volume1/docker/appdata-backup/backup.sh`
- Paste in script contents below.
- `chmod +x /volume1/docker/appdata-backup/backup.sh`
- Synology task scheduler:
  - General
    ...
    - Enabled: Yes
  - Task Settings:
    - Run command: `bash /volume1/docker/appdata-backup/backup.sh`
